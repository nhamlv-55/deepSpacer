...
class SpacerWrapper:
    ...
    def start(self, inputFile, userOptions):
        ...
        self.spacerProcess = run(args, stdout=stat_file, stderr=verbose_file, universal_newlines=True)
        ...
        return self.spacerProcess, graph_json, progress_trace
    ...
    def startIterative(self, inputFile, userOptions):
        ...
        return self.spacerProcess, "success"
